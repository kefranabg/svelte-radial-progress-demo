...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</div></div></div> <div class="flex items-center justify-center mt-4"><div style="${"height: " + escape(containerHeight, true) + "px; width: " + escape(containerWidth, true) + "px;"}" class="border-2 border-white p-4 rounded-lg">${validate_component(RadialProgress, "RadialProgress").$$render(
    $$result,
    {
      data: progressData,
      maxTotalSize,
